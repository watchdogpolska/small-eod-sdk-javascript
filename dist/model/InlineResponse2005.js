...
var _ModelCase = _interopRequireDefault(require("./ModelCase"));
...
var InlineResponse2005 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse2005(count, results) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_ModelCase["default"]]);
        }
