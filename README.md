...
*SmallEodClient.CollectionsApi* | [**collectionsCaseEventList**](docs/CollectionsApi.md#collectionsCaseEventList) | **GET** /collections/{collection_pk}/case/{case_pk}/event/ | 
*SmallEodClient.CollectionsApi* | [**collectionsCaseEventRead**](docs/CollectionsApi.md#collectionsCaseEventRead) | **GET** /collections/{collection_pk}/case/{case_pk}/event/{id}/ | 
*SmallEodClient.CollectionsApi* | [**collectionsCaseLetterList**](docs/CollectionsApi.md#collectionsCaseLetterList) | **GET** /collections/{collection_pk}/case/{case_pk}/letter/ | 
*SmallEodClient.CollectionsApi* | [**collectionsCaseLetterRead**](docs/CollectionsApi.md#collectionsCaseLetterRead) | **GET** /collections/{collection_pk}/case/{case_pk}/letter/{id}/ | 
*SmallEodClient.CollectionsApi* | [**collectionsCaseList**](docs/CollectionsApi.md#collectionsCaseList) | **GET** /collections/{collection_pk}/case/ | 
*SmallEodClient.CollectionsApi* | [**collectionsCaseNoteList**](docs/CollectionsApi.md#collectionsCaseNoteList) | **GET** /collections/{collection_pk}/case/{case_pk}/note/ | 
*SmallEodClient.CollectionsApi* | [**collectionsCaseNoteRead**](docs/CollectionsApi.md#collectionsCaseNoteRead) | **GET** /collections/{collection_pk}/case/{case_pk}/note/{id}/ | 
*SmallEodClient.CollectionsApi* | [**collectionsCaseRead**](docs/CollectionsApi.md#collectionsCaseRead) | **GET** /collections/{collection_pk}/case/{id}/ | 
...
*SmallEodClient.FilesApi* | [**filesCreate**](docs/FilesApi.md#filesCreate) | **POST** /files/ | 
*SmallEodClient.FilesApi* | [**filesDelete**](docs/FilesApi.md#filesDelete) | **DELETE** /files/{id}/ | 
*SmallEodClient.FilesApi* | [**filesList**](docs/FilesApi.md#filesList) | **GET** /files/ | 
*SmallEodClient.FilesApi* | [**filesPartialUpdate**](docs/FilesApi.md#filesPartialUpdate) | **PATCH** /files/{id}/ | 
*SmallEodClient.FilesApi* | [**filesRead**](docs/FilesApi.md#filesRead) | **GET** /files/{id}/ | 
*SmallEodClient.FilesApi* | [**filesUpdate**](docs/FilesApi.md#filesUpdate) | **PUT** /files/{id}/ | 
